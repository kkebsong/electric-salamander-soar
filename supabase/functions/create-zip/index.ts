...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Edge Function (create-zip): SUPABASE_URL:', supabaseUrl ? 'set' : 'not set');
    console.log('Edge Function (create-zip): SUPABASE_SERVICE_ROLE_KEY:', supabaseServiceRoleKey ? 'set' : 'not set');
